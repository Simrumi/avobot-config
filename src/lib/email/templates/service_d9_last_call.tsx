...
export default function ServiceD9LastCall({ lead }: { lead: Lead }) {
  return (
    <EmailLayout leadId={lead.id} preview="Final nudge before I close the loop.">
      ...
      <Text style={{ fontSize: 16, lineHeight: 1.6 }}>
        We only onboard 3 SMEs a month because we build every agent live alongside the client. If your support queue is still eating hours your team can&apos;t get back, this is the door.
      </Text>
