...
export default function SalesD9LastCall({ lead }: { lead: Lead }) {
  return (
    <EmailLayout leadId={lead.id} preview="Final nudge before I close the loop.">
      ...
      <Text style={{ fontSize: 16, lineHeight: 1.6 }}>
        We only onboard 3 SMEs a month because we build every agent live alongside the client. If your leads are still going cold between first contact and second touch, this is the door.
      </Text>
