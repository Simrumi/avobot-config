...
export default function TeamD9LastCall({ lead }: { lead: Lead }) {
  return (
    <EmailLayout leadId={lead.id} preview="Final nudge before I close the loop.">
      ...
      <Text style={{ fontSize: 16, lineHeight: 1.6 }}>
        We only onboard 3 SMEs a month because we build every agent live alongside the client. If your team&apos;s handoffs are still costing you hours you can&apos;t get back, this is the door.
      </Text>
